$(document).ready(function(){
    ...
    function compute_data(building_type, collected_data){
       ...
       console.log("compute_data");
        ...
        if( building_type == "residential") {
          var nb_appartments = parseInt(getElementById("nb_appartments").value);
          var nb_floors = parseInt(getElementById("nb_floors").value);
          var total = nb_appartments * nb_floors;
 ...
 function CollectData() {
     ...
     if( building_type == "residential") {
         var nb_appartments = parseInt(document.getElementById("nb_appartments").value);
         console.log(nb_appartments);
        donnees["nb_appartments"] = nb_appartments;
       
         var nb_floors = parseInt(document.getElementById("nb_floors").value);
        console.log(nb_floors);
        donnees["nb_floors"] = nb_floors;
       

         var nb_basements = parseInt($('#nb_basements').val());
         donnees["nb_basements"] = nb_basements;
         console.log(nb_basements);  
        
        average = nb_appartments*nb_floors;
